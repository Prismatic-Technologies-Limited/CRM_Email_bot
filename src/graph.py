...
from .nodes import Nodes # Corrected import: import Nodes, not NodesWithAPI

class Workflow():
    def __init__(self):
        # initiate graph state & nodes
        workflow = StateGraph(GraphState)
        nodes = Nodes() # Use the Nodes class
        ...
        workflow.add_node("create_draft_response", nodes.create_draft_response) # This node is present but not explicitly used in an edge path yet.
